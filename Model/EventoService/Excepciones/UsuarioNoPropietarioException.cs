...
namespace Es.Udc.DotNet.PracticaMaD.Model.EventoService
{
    ...
    public class UsuarioNoPropietarioException : Exception
    {
        ...
        public UsuarioNoPropietarioException(String info, Exception exception) : base("El usuario no es el propietario del comentario: " + info + "Exception: " + ((exception!= null)?exception.Message:"")) { }
