...
{
    [TestClass()]
    public class IRecomendacionServiceTest
    {
        ...
        ///</summary>
        [TestMethod()]
        public void ServicioEvento_RecomendarEventoTest()
        {
        ...
        public void ServicioEvento_RecomendarEventoEventoIncorrectoTest()
        {
            List<Grupo> grupos = new List<Grupo>();
            grupos.Add(grupo);
        ...
        ///</summary>
        [TestMethod()]
        [ExpectedException(typeof(SinGruposException))]
        public void ServicioEvento_RecomendarEventoANingunGrupoTest()
        {
            List<Grupo> grupos = new List<Grupo>();
            grupos.Add(grupo);
            EventoService.RecomendarEvento(evento1.idEvento, new List<Grupo>(), "Esto es un comentario");
        }
        ...
        ///</summary>
        [TestMethod()]
        public void ServicioEvento_MostrarRecomendacionesTest()
        {
        ...
        [TestMethod()]
        [ExpectedException(typeof(InstanceNotFoundException))]
        public void ServicioEvento_MostrarRecomendacionesUsuarioNoExisteTest()
        {
        ...
        ///</summary>
        [TestMethod()]
        public void ServicioEvento_GrupoRecomendadoTest()
        {
            List<Grupo> grupos = new List<Grupo>();
            grupos.Add(grupo);
            String comentario = "Recomiendo este evento";
        ...
        [TestMethod()]
        [ExpectedException(typeof(InstanceNotFoundException))]
        public void ServicioEvento_GrupoRecomendadoEventoNoExisteTest()
        {
            List<Grupo> grupos = new List<Grupo>();
            grupos.Add(grupo);
            String comentario = "Recomiendo este evento";
            ...
            Assert.IsTrue(EventoService.GrupoRecomendado(NON_EXISTING_EVENT, grupo.idGrupo));
        }
        ...
        [TestMethod()]
        [ExpectedException(typeof(InstanceNotFoundException))]
        public void ServicioEvento_GrupoRecomendadoGrupoNoExisteTest()
        {
            List<Grupo> grupos = new List<Grupo>();
            grupos.Add(grupo);
            String comentario = "Recomiendo este evento";
            ...
            Assert.IsTrue(EventoService.GrupoRecomendado(evento1.idEvento, NON_EXISTING_GROUP));
        }
    }
