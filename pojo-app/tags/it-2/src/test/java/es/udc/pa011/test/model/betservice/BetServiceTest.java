...
public class BetServiceTest {
    ...
    /* CREATE AND FIND BET */
    @Test
    public void testCreateAndFindBetByUserId() 
    	...
    	BetType betType = new BetType("question", event, true, null);
    	...
    	betService.createBet(2.2, userProfile2.getUserProfileId(), option.getOptionId());
    	expectedBets.add(betService.createBet(1.5, userProfile.getUserProfileId(), option.getOptionId()));
    	expectedBets.add(betService.createBet(2.1, userProfile.getUserProfileId(), option.getOptionId()));
    	betService.createBet(1.3, userProfile2.getUserProfileId(), option.getOptionId());
    	expectedBets.add(betService.createBet(1.7, userProfile.getUserProfileId(), option.getOptionId()));
    ...
    public void testNonExistenOption() 
    		throws InstanceNotFoundException, InputValidationException,
                   InvalidDateException{
    	...
    	betService.createBet(1.5, userProfile.getUserProfileId(), NON_EXISTENT_OPTION_ID);
    }
    
    /* CREATE A BET WHIT NON EXISTEN OPTION */
    @Test(expected = InstanceNotFoundException.class)
    public void testNonExistenProfile() 
    		throws InstanceNotFoundException, InputValidationException,
                   InvalidDateException{
    	...
    	betService.createBet(1.5, NON_EXISTENT_USERPROFILE_ID, option.getOptionId());
    }
    ...
    /* CREATE BET WHIT EVENT STARTED */
    @Test(expected = InvalidDateException.class)
    public void testCreateWhitEventStarted() 
    		throws InstanceNotFoundException, InputValidationException,
                   InvalidDateException{
    ...
    @Test
    public void testNonExistentBet() 
    		throws InstanceNotFoundException, InputValidationException,
                   InvalidDateException{
    	...
    	betService.createBet(1.5, userProfile.getUserProfileId(), option.getOptionId());
    	betService.createBet(2.1, userProfile.getUserProfileId(), option.getOptionId());
    	betService.createBet(1.7, userProfile.getUserProfileId(), option.getOptionId());
