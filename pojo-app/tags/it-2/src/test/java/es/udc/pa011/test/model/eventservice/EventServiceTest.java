...
public class EventServiceTest {
  ...
  //*********** CREATE A EVENT WITH DATE BEFORE TODAY **********
    ...
    public void testFindEventsByKeywordsAndCategoryAdmin() throws InstanceNotFoundException, DateBeforeTodayException{
        ...
        //Empty list
        assertTrue (eventService.findEventByKeyWordsAndCategory("Deportivo - Real Madrid", Boolean.TRUE, idFutbol, 0, 2).getEvents().size()==0);
        ...
        do {
        	...
        	eventBlock = eventService.findEventByKeyWordsAndCategory(
            		completeKeyWords, Boolean.TRUE, idFutbol, startIndex, count);
        ...
        do {
            ...
            eventBlock = eventService.findEventByKeyWordsAndCategory(
            		parcialKeyWords, Boolean.TRUE, idFutbol, startIndex, count);
        ...
        do {
        	...
        	eventBlock = eventService.findEventByKeyWordsAndCategory(
            		messyKeyWords, Boolean.TRUE, idFutbol, startIndex, count);
    ...
    public void testFindEventsByKeywordsAdmin() throws InstanceNotFoundException, DateBeforeTodayException{
        ...
        do {
        	...
        	eventBlock = eventService.findEventByKeyWordsAndCategory(
            		completeKeyWords, Boolean.TRUE, null, startIndex, count);
    ...
    public void testFindEventsByCategoryAdmin() throws InstanceNotFoundException, DateBeforeTodayException{
        ...
        do {
            ...
            eventBlock = eventService.findEventByKeyWordsAndCategory(
            		null, Boolean.TRUE, idFutbol, startIndex, count);
  ...
  //********** FIND EVENTS - ADMIN **********
    ...
    public void testFindEventsAdmin() throws InstanceNotFoundException, DateBeforeTodayException{
        ...
        do {
        	...
        	eventBlock = eventService.findEventByKeyWordsAndCategory(
            		null, Boolean.TRUE, null, startIndex, count);
  ...
  //********** FIND EVENTS - USER **********
    ...
    public void testFindEventsUser() throws InstanceNotFoundException, DateBeforeTodayException{
        ...
        do {
        	...
        	eventBlock = eventService.findEventByKeyWordsAndCategory(
            		null, Boolean.FALSE, null, startIndex, count);
  ...
  //********** CREATE AND FIND BETTYPES BY EVENT AND OPTIONS BY BETTYPE **********
    ...
    public void testCreateAndFindBetTypesAndOptions()
        ...
        BetType betType = new BetType("¿Quien será el ganador?", event, false, options);
        
        BetType newBetType = 
        		eventService.createBetType(event.getEventId(), betType); 
        
        newBetType.setOptions(options);
        
        BetType betTypeWinner = 
        		eventService.createBetType(event.getEventId(), newBetType);
    ...
    public void testBetTypeNonExistentEvent() throws InstanceNotFoundException { 
        BetType betType = new BetType("pregunta", null, true, null);
    	eventService.createBetType(NON_EXISTENT_EVENT_ID, betType);
    }
    ...
    public void testOptionNonExistentBetType() throws InstanceNotFoundException {  
        BetType betType = new BetType("pregunta", null, true, null);
    	eventService.createBetType(NON_EXISTENT_BETTYPE_ID, betType);
    ...
    //*********** WINNER OPTIONS **********
    @Test
    public void testWinnerOptions() throws InstanceNotFoundException, DateBeforeTodayException, ManyWinOptionsException {
    	//CREATE CATEGORY
    	Category categoryFutbol = new Category("futbol");
    	categoryDao.save(categoryFutbol);
    	Long idFutbol = categoryFutbol.getCategoryId();
        ...
        Set<Option> options = new HashSet<Option>();
        Option optionWinnerDeportivo = new Option ("Deportivo", 1.5);
        Option optionWinnerValencia = new Option ("Valencia", 1.2);
        Option optionWinnerRealMadrid = new Option ("Real Madrid", 1);
       
        options.add(optionWinnerDeportivo);
        options.add(optionWinnerValencia);
        options.add(optionWinnerRealMadrid);
        
        BetType betType = new BetType("¿Quien será el ganador?", event, true, options);
        ...
        winnerOptions.add(optionWinnerValencia.getOptionId());
        
        eventService.winnerOptions(winnerOptions, newBetType.getBetTypeId());
        
        assertTrue(optionWinnerDeportivo.isWinner());
        assertTrue(optionWinnerValencia.isWinner());
        assertFalse(optionWinnerRealMadrid.isWinner());
    }
    
    //*********** WINNER OPTIONS LIST EMPTY **********
    @Test
    public void testWinnerOptionsEmpty() throws InstanceNotFoundException, DateBeforeTodayException, ManyWinOptionsException{
    	//CREATE CATEGORY
    	Category categoryFutbol = new Category("futbol");
    	categoryDao.save(categoryFutbol);
    	Long idFutbol = categoryFutbol.getCategoryId();
        ...
        BetType betType = new BetType("¿Quien será el ganador?", event, false, null);
    ...
    @Test(expected = InstanceNotFoundException.class)
    public void testWinnerOptionsNonExistentBetType() throws InstanceNotFoundException, ManyWinOptionsException {
        eventService.winnerOptions(null, NON_EXISTENT_BETTYPE_ID);
    }
    
    //*********** WINNER OPTIONS MORE THAN MAX **********
    @Test(expected = ManyWinOptionsException.class)
    public void testManyWinOption() throws InstanceNotFoundException, ManyWinOptionsException {
