...
namespace Es.Udc.DotNet.PracticaMaD.TestNUnit.TestsDAOs
{
    ...
    public class UnitTest1
    {
        ...
        public static Gen<int> ValueWithMinMax(int min, int max) {
        ...
        public void PR_UN_01()
        {
            try
            {
                Collection<Comentario> comentarios = comentarioDao.VerComentarios(ValueWithMinMax(0, 100).Sample<int>(), 0, 10);
